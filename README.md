...
#### v.1.5
 ...
 - Notify natively terminated downloading process. **Clean install is recommended. If you prefer to upgrade, please update dependencies by** `$ npm install` **command**.
#### v.1.5.1
 - Fix syntax error
#### v.1.6
